    ...
    <>
                ...
                <tbody>
                  {isEditMode ? (
                    ...
                    <React.Fragment>
                      ...
                      <tr className="border-b">
                        <td className="p-2 font-medium text-sm">작성일</td>
                        <td className="p-2 text-sm">{formatCreatedAt}</td>
                      </tr>
      ...
      <div className="ml-56">
        ...
        <div>
                ...
                <table className="w-full table-auto text-left">
                  <tbody>
                    <tr className="w-full">
                      ...
                      <button
                        onClick={handlerSubmitReply}
                        className=" m-5 px-3 py-1 w-24 bg-blue-500 text-white rounded whitespace-nowrap"
                      >
                        등록
                      </button>
                    </tr>
                      ...
                      .map((reply) => (
                        ...
                        >
                          <td className="whitespace-nowrap px-6 py-4 font-medium flex justify-between">
                            ...
                            <span className="mr-20">{reply.comment}</span>
                            {reply.userId === authData.id ||
                            authData.role === "ADMIN" ? (
                              <React.Fragment>
                                <button
                                  onClick={() => {
          ...
          <Card className="h-full w-auto mx-4"></Card>
        </div>
      </div>
    </>
  );
