        ...
        <header>
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className={`${isMenuOpen ? 'flex flex-col' : 'hidden'} absolute right-0 w-1/4 top-[3rem] lg:flex lg:flex-row lg:items-center lg:w-auto lg:relative z-10 mr-6`} id="mobile-menu-2">
