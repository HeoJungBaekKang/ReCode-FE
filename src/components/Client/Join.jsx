...
const CheckUsernameDuplicate = async (username) => {
  ...
  try {
    const response = await fetch(`http://localhost:8080/api/user-name/${username}/exists`);
...
const CheckEmailDuplicate = async (email) => {
  ...
  try {
    const response = await fetch(`http://localhost:8080/api/user-email/${email}/exists`);
    console.log(response)
    const result = await response.json();
    console.log(result)
    return result;
