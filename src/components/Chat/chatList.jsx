                                        ...
                                        {chatRooms.map((room) => (
                                            <React.Fragment key={room.chatRoomId}>
                                                ...
                                                <div className="flex justify-center mt-2">
                                                    <button
                                                        className="p-4 border-none bg-transparent flex items-center justify-center"
                                                        key={`delete-${room.chatRoomId}`}
                                                        onClick={() =>
                                                            handleDeleteChatRoom(room.chatRoomId)
                                                        }
                                                    >
                                                        <img
                                                            src="/img/delete.png"
